    ...
    <form id="addForm">
        ...
        <div class="div2">
            <table class="table_d2"cellspacing=""cellpadding="" id="table_new">
                ...
                <tr>
                    <td></td><td></td>
                    <td class="c"><button class="button11" name="add_degree" onclick="addRow();return false;">新增</button></td>
                </tr>
            </table>
        </div>
        ...
        <div class="div2" id="new_div">
            <table>
                <tr><td class="c"><button class="button_new" name="add_and" onclick="addDiv();return false;">新增与</button></td></tr>
            </table>
        ...
        <div class="div2">
            <table class="table_d2" cellpadding="" cellspacing="">
                <tr><td class="c">组队开始时间</td>
                    <td class="c"><p5><input type="date" id="start_time"> </p5></td>
                </tr>
                <tr><td class="c">组队截止时间</td>
                    <td class="c"><p5><input type="date" id="end_time"> </p5></td>
                </tr>
            </table>
        </div>
